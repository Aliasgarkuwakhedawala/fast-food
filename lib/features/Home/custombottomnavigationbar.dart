  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          color: backgroundColor.withOpacity(.4), // Semi-transparent background
          borderRadius: BorderRadius.circular(borderRadius), // Curved corners
      ...
      child: ClipRRect(
        borderRadius:
            BorderRadius.circular(borderRadius), // Clip for rounded corners
        child: BottomNavigationBar(
          type: BottomNavigationBarType.fixed, // Ensure all items fit
          elevation: 0,
          backgroundColor:
              Colors.transparent, // Transparent background to match container
